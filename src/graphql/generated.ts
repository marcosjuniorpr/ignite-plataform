...
export type GetLessonByshlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessonByshlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const GetLessonByshlugDocument = gql`
    query GetLessonByshlug($slug: String) {
...
/**
 * __useGetLessonByshlugQuery__
 *
 * To run a query within a React component, call `useGetLessonByshlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonByshlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonByshlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessonByshlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonByshlugQuery, GetLessonByshlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonByshlugQuery, GetLessonByshlugQueryVariables>(GetLessonByshlugDocument, options);
      }
export function useGetLessonByshlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonByshlugQuery, GetLessonByshlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonByshlugQuery, GetLessonByshlugQueryVariables>(GetLessonByshlugDocument, options);
        }
export type GetLessonByshlugQueryHookResult = ReturnType<typeof useGetLessonByshlugQuery>;
export type GetLessonByshlugLazyQueryHookResult = ReturnType<typeof useGetLessonByshlugLazyQuery>;
export type GetLessonByshlugQueryResult = Apollo.QueryResult<GetLessonByshlugQuery, GetLessonByshlugQueryVariables>;
